...
El programa, al recibir como dato una serie de calificaciones, obtiene el rango en 
...
int RA4 = 0;
int RA5 = 0;
/*El uso de variables globales no es muy recomendable. En estos problemas se utilizan 
únicamente con el objetivo de que el lector pueda observar la forma en que se aplican.*/
